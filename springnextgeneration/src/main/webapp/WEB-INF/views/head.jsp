<!DOCTYPE html>
<html lang="en"><!-- use class="debug" here if you develop a template and want to check-->
<head>
	<meta charset="UTF-8" />
	<meta name="viewport" content="width=device-width, minimum-scale=1.0, maximum-scale=1.0" />
   	<!-- some meta tags, important for SEO"--> 
    <meta name="description" content="Spring Next Generation: The series" />
    <meta name="keywords" content="java spring object OO aop transactions" />
	...
	<title>Spring Next Generation Series</title>
            ...
            <link rel="stylesheet" href="resources/css/fluid-grid16-1100px.css" />
            <link rel="stylesheet" href="resources/css/eve-styles.css" />
            <link rel="shortcut icon" href="icon.png" />
            <link rel="apple-touch-icon-precomposed" href="resources/img/icon.png" />
